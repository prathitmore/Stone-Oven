import{W as B,A as Y,S as D,F as H,P as $,a as N,b as L,V as O,M as F,B as _,c as P,d as X,e as q,C as W}from"./three.module.js";import{g as b,o as j}from"./index.js";import{i as U}from"./tilt.js";function V(){return`
    ...
    `}function G(){const f=document.getElementById("hero-canvas");if(!f)return;const g=window.innerWidth<=768,v=new B({canvas:f,alpha:!0,antialias:!g,powerPreference:"high-performance"});v.setSize(window.innerWidth,window.innerHeight),v.setPixelRatio(Math.min(window.devicePixelRatio,g?1:1.5)),v.toneMapping=Y,v.toneMappingExposure=1;const T=new D;T.fog=new H(1115136,.015);const h=new $(g?70:50,window.innerWidth/window.innerHeight,.1,1e3);h.position.set(0,10,40);const w=g?48:80,t=new N(120,120,w,w),i=new L({uniforms:{uTime:{value:0},uMouse:{value:new O(0,0)}},wireframe:!1,vertexShader:`
            uniform float uTime;
            uniform vec2 uMouse;
            varying vec2 vUv;
        ...
        `,transparent:!0}),e=new F(t,i);e.rotation.x=-Math.PI/2+.2,e.position.y=-5,e.position.z=-20,T.add(e);const r=g?150:600,n=new _,m=new Float32Array(r*3),y=new Float32Array(r),l=new Float32Array(r);for(let o=0;o<r;o++)m[o*3]=(Math.random()-.5)*80,m[o*3+1]=(Math.random()-.5)*20,m[o*3+2]=(Math.random()-.5)*60-10,y[o]=Math.random()*.8+.2,l[o]=Math.random()*100;n.setAttribute("position",new P(m,3)),n.setAttribute("aScale",new P(y,1)),n.setAttribute("aLife",new P(l,1));const c=new L({transparent:!0,depthWrite:!1,blending:X,uniforms:{uTime:{value:0}},vertexShader:`
        ...
        `}),x=new q(n,c);T.add(x);let z=0,E=0,C=0,A=0,S=0,I=0;const a=window.innerWidth/2,d=window.innerHeight/2,s=(o,M)=>{z=(o-a)*.002,E=(M-d)*.002,S=o/window.innerWidth,I=1-M/window.innerHeight;const R=document.getElementById("hero-light");R&&(R.style.background=`radial-gradient(circle 800px at ${o}px ${M}px, rgba(255, 60, 0, 0.06), transparent)`)};document.addEventListener("mousemove",o=>s(o.clientX,o.clientY)),document.addEventListener("touchstart",o=>{o.touches.length>0&&s(o.touches[0].clientX,o.touches[0].clientY)},{passive:!0}),document.addEventListener("touchmove",o=>{o.touches.length>0&&s(o.touches[0].clientX,o.touches[0].clientY)},{passive:!0});const p=new W;function u(){requestAnimationFrame(u);const o=p.getElapsedTime();C=z*2,A=E*2,h.position.x+=(C-h.position.x)*.02,h.position.y+=(10+A-h.position.y)*.02,h.lookAt(0,5,-20),i.uniforms.uTime.value=o,i.uniforms.uMouse.value.x+=(S-i.uniforms.uMouse.value.x)*.05,i.uniforms.uMouse.value.y+=(I-i.uniforms.uMouse.value.y)*.05,c.uniforms.uTime.value=o,v.render(T,h),window.hero3DReady||(window.hero3DReady=!0)}u();const k=()=>{h.aspect=window.innerWidth/window.innerHeight,h.updateProjectionMatrix(),v.setSize(window.innerWidth,window.innerHeight)};window.removeEventListener("resize",window._heroResizeHandler),window._heroResizeHandler=k,window.addEventListener("resize",k)}const Z=[{id:"dish-1",name:"Butter Chicken Pizza",description:"Tender tandoori chicken in rich makhani sauce on a stone-fired base.",image:b("masterpiece_pizza_1.png")},{id:"dish-2",name:"Mexican Paneer Pizza",description:"Spicy paneer chunks, jalapeños, and bell peppers.",image:b("masterpiece_pizza_2.png")},{id:"dish-3",name:"BBQ Chicken Pizza",description:"Smoky BBQ sauce reduction, soft paneer chunks.",image:b("masterpiece_pizza_3.png")}];function ee(){return`
        <div class="home-page">
            ${V()}
            ...
            <section class="heritage-section reveal" style="padding: 12vw 5%; background: #080808; display: grid; grid-template-columns: 1fr 1fr; gap: 8vw; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.03);">
                <div id="heritage-img-wrap" style="position: relative; perspective: 1200px;">
                    <div id="heritage-card-3d" style="position: relative; border-radius: 4px; overflow: visible; transform-style: preserve-3d; animation: float3d 6s ease-in-out infinite; transition: transform 0.1s ease;">
                        <img src="${b("virar_drink.jpg")}" style="width: 100%; height: 60vh; object-fit: cover; border-radius: 4px; display: block; filter: brightness(0.85) contrast(1.1);" alt="Stone Oven Virar Outlet Drink">
            ...
            <section id="masterpiece-showcase" style="position: relative; width: 100%; min-height: 100vh; background: #050505; overflow: hidden; display: flex; align-items: center; justify-content: center; color: #fff;">
                ...
                <div id="masterpiece-ingredients" style="position: absolute; inset: 0; z-index: 2; pointer-events: none; opacity: 0.4; transition: transform 1.2s cubic-bezier(0.16, 1, 0.3, 1);">
                    <img src="${b("ingredients_flying.png")}" style="position: absolute; top: -5%; left: -5%; width: 50vw; transform: rotate(-10deg); filter: blur(2px);">
                    <img src="${b("ingredients_flying.png")}" style="position: absolute; bottom: -5%; right: -5%; width: 50vw; transform: scale(-1) rotate(10deg); filter: blur(4px);">
                </div>
                ...
                <div style="position: relative; width: 100%; max-width: 1600px; height: 100%; z-index: 3; display: grid; grid-template-columns: minmax(300px, 1fr) minmax(350px, 1fr); gap: 10vw; align-items: center; padding: 0 10%;">
                    ...
                    <div style="display: flex; align-items: center; justify-content: flex-start; min-height: 50vh;">
                        <div id="hero-pizza-wrap" style="position: relative; width: 100%; max-width: 480px; transition: transform 1s cubic-bezier(0.16, 1, 0.3, 1);">
                            <!-- The Main Pizza -->
                            <img id="masterpiece-img" src="${b("masterpiece_pizza_1.png")}" style="width: 100%; border-radius: 50%; box-shadow: 0 40px 80px rgba(0,0,0,0.9), 0 0 120px rgba(255,60,0,0.1); transition: opacity 0.4s ease, transform 0.6s cubic-bezier(0.16, 1, 0.3, 1);">
