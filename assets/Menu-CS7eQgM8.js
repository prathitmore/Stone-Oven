import{W as v,S as y,P as z,a as w,b as k,D as x,f as _,M as C,o as P}from"./three.module-DRDOGXzl.js";import{i as B}from"./tilt-fQ6J8_vA.js";function u(o){const c=document.getElementById(o);if(!c)return;const l=c.parentElement,r=new v({canvas:c,alpha:!0,antialias:!1}),n=l.getBoundingClientRect();r.setSize(n.width,n.height),r.setPixelRatio(Math.min(window.devicePixelRatio,1.5));const e=new y,a=new z(75,n.width/n.height,.1,1e3);a.position.z=30;const t=new w(n.width*.15,n.height*.15,32,32),s=new k({uniforms:{uTime:{value:0},uColor:{value:new _(16731392)}},vertexShader:`
            uniform float uTime;
            varying vec2 vUv;
