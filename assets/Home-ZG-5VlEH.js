import{W as L,A as B,S as Y,F as D,P as H,a as $,b as R,V as N,M as O,B as F,c as k,d as _,e as X,C as q,o as W}from"./three.module-CioQiq5y.js";import{i as j}from"./tilt-fQ6J8_vA.js";function U(){return`
    ...
    `}function V(){const g=document.getElementById("hero-canvas");if(!g)return;const m=window.innerWidth<=768,v=new L({canvas:g,alpha:!0,antialias:!m,powerPreference:"high-performance"});v.setSize(window.innerWidth,window.innerHeight),v.setPixelRatio(Math.min(window.devicePixelRatio,m?1:1.5)),v.toneMapping=B,v.toneMappingExposure=1;const S=new Y;S.fog=new D(1115136,.015);const h=new H(m?70:50,window.innerWidth/window.innerHeight,.1,1e3);h.position.set(0,10,40);const w=m?48:80,t=new $(120,120,w,w),i=new R({uniforms:{uTime:{value:0},uMouse:{value:new N(0,0)}},wireframe:!1,vertexShader:`
            uniform float uTime;
            uniform vec2 uMouse;
            varying vec2 vUv;
        ...
        `,transparent:!0}),e=new O(t,i);e.rotation.x=-Math.PI/2+.2,e.position.y=-5,e.position.z=-20,S.add(e);const r=m?150:600,n=new F,f=new Float32Array(r*3),y=new Float32Array(r),l=new Float32Array(r);for(let o=0;o<r;o++)f[o*3]=(Math.random()-.5)*80,f[o*3+1]=(Math.random()-.5)*20,f[o*3+2]=(Math.random()-.5)*60-10,y[o]=Math.random()*.8+.2,l[o]=Math.random()*100;n.setAttribute("position",new k(f,3)),n.setAttribute("aScale",new k(y,1)),n.setAttribute("aLife",new k(l,1));const c=new R({transparent:!0,depthWrite:!1,blending:_,uniforms:{uTime:{value:0}},vertexShader:`
        ...
        <div class="home-page">
            ...
            <section class="heritage-section reveal" style="padding: 12vw 5%; background: #080808; display: grid; grid-template-columns: 1fr 1fr; gap: 8vw; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.03);">
                <div id="heritage-img-wrap" style="position: relative; perspective: 1200px;">
                    <div id="heritage-card-3d" style="position: relative; border-radius: 4px; overflow: visible; transform-style: preserve-3d; animation: float3d 6s ease-in-out infinite; transition: transform 0.1s ease;">
                        <img src="${g}virar_drink.jpg" style="width: 100%; height: 60vh; object-fit: cover; border-radius: 4px; display: block; filter: brightness(0.85) contrast(1.1);" alt="Stone Oven Virar Outlet Drink">
            ...
            <section id="masterpiece-showcase" style="position: relative; width: 100%; min-height: 100vh; background: #050505; overflow: hidden; display: flex; align-items: center; justify-content: center; color: #fff;">
                ...
                <div id="masterpiece-ingredients" style="position: absolute; inset: 0; z-index: 2; pointer-events: none; opacity: 0.4; transition: transform 1.2s cubic-bezier(0.16, 1, 0.3, 1);">
                    <img src="${g}ingredients_flying.png" style="position: absolute; top: -5%; left: -5%; width: 50vw; transform: rotate(-10deg); filter: blur(2px);">
                    <img src="${g}ingredients_flying.png" style="position: absolute; bottom: -5%; right: -5%; width: 50vw; transform: scale(-1) rotate(10deg); filter: blur(4px);">
                </div>
                ...
                <div style="position: relative; width: 100%; max-width: 1600px; height: 100%; z-index: 3; display: grid; grid-template-columns: minmax(300px, 1fr) minmax(350px, 1fr); gap: 10vw; align-items: center; padding: 0 10%;">
                    ...
                    <div style="display: flex; align-items: center; justify-content: flex-start; min-height: 50vh;">
                        <div id="hero-pizza-wrap" style="position: relative; width: 100%; max-width: 480px; transition: transform 1s cubic-bezier(0.16, 1, 0.3, 1);">
                            <!-- The Main Pizza -->
                            <img id="masterpiece-img" src="${g}masterpiece_pizza_1.png" style="width: 100%; border-radius: 50%; box-shadow: 0 40px 80px rgba(0,0,0,0.9), 0 0 120px rgba(255,60,0,0.1); transition: opacity 0.4s ease, transform 0.6s cubic-bezier(0.16, 1, 0.3, 1);">
                    ...
                    ${W.slice(0,4).map((m,v)=>`
                        <div class="destination-card reveal" data-tilt style="position: relative; height: 75vh; overflow: hidden; border-radius: 4px; cursor: pointer;">
                            ...
                            <div class="card-content-inner" style="position: absolute; bottom: 4rem; left: 4rem; right: 4rem;">
                                <div style="color: #ff3c00; font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.6em; margin-bottom: 12px; font-weight: 800;">Destination 0${v+1}</div>
    ...
    `}function J(){const g=window.innerWidth<=768;V(),j();const m=document.getElementById("heritage-img-wrap"),v=document.getElementById("heritage-card-3d");m&&v&&(m.addEventListener("mousemove",t=>{const i=m.getBoundingClientRect(),e=(t.clientX-i.left)/i.width-.5,r=(t.clientY-i.top)/i.height-.5;v.style.animation="none",v.style.transform=`rotateX(${-r*18}deg) rotateY(${e*18}deg) translateY(-8px)`}),m.addEventListener("touchstart",t=>{const i=t.touches[0],e=m.getBoundingClientRect(),r=(i.clientX-e.left)/e.width-.5,n=(i.clientY-e.top)/e.height-.5;v.style.animation="none",v.style.transform=`rotateX(${-n*22}deg) rotateY(${r*22}deg) translateY(-12px)`},{passive:!0}),m.addEventListener("mouseleave",()=>{v.style.animation="float3d 6s ease-in-out infinite",v.style.transform=""}),m.addEventListener("touchend",()=>{v.style.animation="float3d 6s ease-in-out infinite",v.style.transform=""},{passive:!0})),document.querySelectorAll(".destination-card").forEach(t=>{t.addEventListener("mousemove",i=>{const e=t.getBoundingClientRect(),r=(i.clientX-e.left)/e.width-.5,n=(i.clientY-e.top)/e.height-.5,f=t.querySelector("img"),y=t.querySelector(".card-content-inner");f&&(f.style.transform=`scale(1.15) translate(${-r*30}px, ${-n*30}px) rotate(${r*2}deg)`),y&&(y.style.transform=`translate3d(${r*25}px, ${n*25}px, 50px)`),t.style.transform=`rotateX(${-n*10}deg) rotateY(${r*10}deg)`}),t.addEventListener("touchstart",i=>{const e=i.touches[0],r=t.getBoundingClientRect(),n=(e.clientX-r.left)/r.width-.5,f=(e.clientY-r.top)/r.height-.5,y=t.querySelector("img"),l=t.querySelector(".card-content-inner");t.classList.add("touch-active"),y&&(y.style.transform=`scale(1.2) translate(${-n*40}px, ${-f*40}px) rotate(${n*4}deg)`),l&&(l.style.transform=`translate3d(${n*35}px, ${f*35}px, 60px)`),t.style.transform=`rotateX(${-f*15}deg) rotateY(${n*15}deg) scale(1.02)`},{passive:!0}),t.addEventListener("mouseleave",()=>{const i=t.querySelector("img"),e=t.querySelector(".card-content-inner");i&&(i.style.transform=""),e&&(e.style.transform=""),t.style.transform=""}),t.addEventListener("touchend",()=>{const i=t.querySelector("img"),e=t.querySelector(".card-content-inner");t.classList.remove("touch-active"),i&&(i.style.transform=""),e&&(e.style.transform=""),t.style.transform=""},{passive:!0})});const h=document.getElementById("cta-embers");if(h){let t=function(){const c=h.parentElement.getBoundingClientRect();r=h.width=c.width,n=h.height=c.height},i=function(){document.getElementById("cta-embers")&&(e.clearRect(0,0,r,n),e.shadowBlur=0,f.forEach(c=>{c.update(),c.draw()}),requestAnimationFrame(i))};const e=h.getContext("2d");let r,n;const f=[];window.addEventListener("resize",t),t();class y{constructor(){this.reset()}reset(){this.x=Math.random()*r,this.y=n+50,this.vx=(Math.random()-.5)*2,this.vy=-Math.random()*3-2,this.size=Math.random()*(g?2.5:3.5)+1,this.alpha=Math.random()*.7+.3,this.life=Math.random()*(g?150:250)+100,this.color=Math.random()>.5?"#ff3c00":"#ff9d00"}update(){this.x+=this.vx+Math.sin(this.y*.01)*.5,this.y+=this.vy,this.life--,this.alpha-=g?.004:.002,(this.life<=0||this.alpha<=0||this.y<-20)&&this.reset()}draw(){e.globalAlpha=this.alpha,e.fillStyle=this.color,g||(e.shadowBlur=12,e.shadowColor=this.color),e.beginPath(),e.arc(this.x,this.y,this.size,0,Math.PI*2),e.fill()}}const l=g?200:750;for(let c=0;c<l;c++)f.push(new y);i()}const w=document.getElementById("masterpiece-showcase");if(w){let t=function(a){const d=G[a];if(!d)return;l=a,b&&clearTimeout(b);const s=document.querySelector(".masterpiece-info");s&&(s.style.opacity="0",s.style.transform="translateY(15px)",s.style.transition="all 0.3s cubic-bezier(0.16, 1, 0.3, 1)"),n&&(n.style.opacity="0",n.style.transform="scale(0.92) rotate(-8deg)",n.style.transition="all 0.3s cubic-bezier(0.16, 1, 0.3, 1)"),b=setTimeout(()=>{if(i&&(i.textContent=d.name),e&&(e.textContent=d.description),r&&(r.textContent=`0${a+1}`),n){const p=new Image;p.src=d.image,p.onload=()=>{n.src=d.image,s&&(s.style.opacity="1",s.style.transform="translateY(0)"),n&&(n.style.opacity="1",n.style.transform="scale(1) rotate(0deg)")}}},200),f&&(f.style.transform=`translateX(${(a-1)*-15}vw) translateZ(0)`),y&&(y.style.transform=`translate(${(a-1)*-80}px, ${(a-1)*50}px) rotate(${(a-1)*15}deg) translateZ(0)`)};const i=document.getElementById("masterpiece-title"),e=document.getElementById("masterpiece-desc"),r=document.getElementById("masterpiece-num"),n=document.getElementById("masterpiece-img"),f=document.getElementById("masterpiece-bg-text"),y=document.getElementById("masterpiece-ingredients");let l=0,c=0,x=!1,b=null,z=0,E=0;const M=()=>{if(!document.getElementById("masterpiece-showcase"))return;if(x&&document.body.style.overflow!=="hidden"&&(document.body.style.overflow="hidden"),x){Math.abs(window.scrollY-E)>10&&window.scrollTo(0,E);return}if(Date.now()-z<1e3)return;const d=w.getBoundingClientRect(),s=window.pageYOffset+d.top,p=g?window.innerHeight*.5:window.innerHeight*.4;if(d.top<p&&d.top>-p){if(x=!0,E=s,g){const u=document.querySelector(".navbar");u&&u.classList.add("nav-hidden")}document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden",window.scrollTo(0,s)}},T=a=>{if(!document.getElementById("masterpiece-showcase")){x&&(x=!1,document.body.style.overflow="");return}if(!x)return;const d=Date.now(),s=a.deltaY>0,p=a.deltaY<0;if(l===0&&p||l===2&&s)if(d-c>1100){x=!1;const u=document.querySelector(".navbar");u&&u.classList.remove("nav-hidden"),z=d,document.body.style.overflow="",document.documentElement.style.overflow="";return}else{a.preventDefault();return}a.preventDefault(),!(d-c<1300)&&(s&&l<2?(c=d,t(l+1)):p&&l>0&&(c=d,t(l-1)))};window.removeEventListener("scroll",window._homeScrollHandler),window.removeEventListener("wheel",window._homeWheelHandler),window._homeScrollHandler=M,window._homeWheelHandler=T,window.addEventListener("scroll",M),window.addEventListener("wheel",T,{passive:!1});let A=0;w.addEventListener("touchstart",a=>{A=a.touches[0].clientY},{passive:!0}),w.addEventListener("touchmove",a=>{document.getElementById("masterpiece-showcase")&&x&&a.preventDefault()},{passive:!1}),w.addEventListener("touchend",a=>{if(!x)return;const d=a.changedTouches[0].clientY,s=A-d,p=Date.now();if(Math.abs(s)<40)return;const u=s>0,I=s<0,o=g?600:1300;if((l===0&&I||l===2&&u)&&p-c>o){x=!1;const C=document.querySelector(".navbar");C&&C.classList.remove("nav-hidden"),z=p,document.body.style.overflow="",document.documentElement.style.overflow="";return}p-c<o||(u&&l<2?(c=p,t(l+1)):I&&l>0&&(c=p,t(l-1)))}),g||w.addEventListener("mousemove",a=>{const{clientX:d,clientY:s}=a,p=(d/window.innerWidth-.5)*40,u=(s/window.innerHeight-.5)*40;pizzaWrap&&(pizzaWrap.style.transform=`translate3d(${p}px, ${u}px, 0) rotateX(${-u/2}deg) rotateY(${p/2}deg)`),f&&(f.style.transform=`translate(${-p/2}px, ${-u/2}px)`)}),t(0)}}export{J as init,Q as renderHome};
