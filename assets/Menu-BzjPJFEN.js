import{o as v}from"./index-DemXuxsN.js";import{i as y}from"./tilt-fQ6J8_vA.js";import{W as z,S as w,P as k,a as x,b as _,D as C,f as P,M as B}from"./three.module-CfHucll0.js";function u(o){const c=document.getElementById(o);if(!c)return;const l=c.parentElement,r=new z({canvas:c,alpha:!0,antialias:!1}),n=l.getBoundingClientRect();r.setSize(n.width,n.height),r.setPixelRatio(Math.min(window.devicePixelRatio,1.5));const e=new w,a=new k(75,n.width/n.height,.1,1e3);a.position.z=30;const t=new x(n.width*.15,n.height*.15,32,32),s=new _({uniforms:{uTime:{value:0},uColor:{value:new P(16731392)}},vertexShader:`
            uniform float uTime;
            varying vec2 vUv;
    ...
    `}function V(){y(),setTimeout(()=>{u("menu-heat-flow-canvas"),["pizza","pasta","italian","mexican","chinese","sandwiches","salads","specialties","risotto","desserts","beverages"].forEach(o=>{u("menu-heat-flow-"+o)})},100)}export{V as init,T as renderMenu};
