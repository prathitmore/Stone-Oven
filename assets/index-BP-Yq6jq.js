const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-BjCeuIbF.js","assets/three.module-EqAcmZ32.js","assets/tilt-fQ6J8_vA.js","assets/Locations-D_JNJKCB.js","assets/HeatFlow-DDV4VBE7.js","assets/Menu-D5rifyPA.js","assets/About-Cg_txZNk.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const f of a.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&t(f)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();function x(){return`
    ...
    `}function L(o){const e=document.getElementById("splash-container"),n=document.getElementById("splash-logo-wrap"),t=document.getElementById("splash-embers");if(!e||!n||!t){o&&o();return}const i=t.getContext("2d");let a,f;const c=[];function l(){a=t.width=window.innerWidth,f=t.height=window.innerHeight}window.addEventListener("resize",l),l();class p{constructor(){this.reset()}reset(){this.x=Math.random()*a,this.y=f+100,this.vx=(Math.random()-.5)*2.5,this.vy=-Math.random()*4-2,this.size=Math.random()*3+1,this.alpha=Math.random()*.6+.3,this.life=Math.random()*150+50}update(){this.x+=this.vx,this.y+=this.vy,this.life--,this.alpha-=.003,(this.life<=0||this.alpha<=0)&&this.reset()}draw(){i.fillStyle=`rgba(255, ${80+Math.random()*120}, 0, ${this.alpha})`,i.beginPath(),i.arc(this.x,this.y,this.size,0,Math.PI*2),i.fill()}}for(let r=0;r<160;r++)c.push(new p);let s;function u(){i.clearRect(0,0,a,f),c.forEach(r=>{r.update(),r.draw()}),s=requestAnimationFrame(u)}u(),setTimeout(()=>{n.style.opacity="1",n.style.transform="scale(1)"},100),setTimeout(()=>{n.style.opacity="0",n.style.transform="scale(1.05)",n.style.filter="blur(15px)"},2200),setTimeout(()=>{o&&o(),e.style.opacity="0",setTimeout(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",l),e.parentNode&&e.remove()},1e3)},3e3)}function T(){return`
    ...
    `}function I(o){const e=document.getElementById("loader-video"),n=document.getElementById("loader-container"),t=document.getElementById("loader-fade"),i=document.getElementById("loader-perc"),a=document.getElementById("loader-progress"),f=document.getElementById("loader-dot"),c=document.getElementById("loader-ui"),l=document.getElementById("ui-top-left"),p=document.getElementById("ui-top-right"),s=document.getElementById("load-status");if(!e)return;const u=window.innerWidth<=768;let r=0,d=!1,v=0;window.addEventListener("load",()=>{}),e.load(),e.play().catch(y=>console.log("Video autoplay blocked",y)),setTimeout(()=>{t&&(t.style.opacity="0")},100);const m=()=>{if(!(d&&r>=100)){if(u){if(e.readyState<2){requestAnimationFrame(m);return}e.paused&&e.play().catch(()=>{}),r+=Math.random()*.8+.4}else{if(e.readyState<3){s&&(s.innerText="● BUFFERING..."),requestAnimationFrame(m);return}e.paused&&e.play().catch(()=>{}),s&&(s.innerText="● AUTHENTIC CRAFT"),e.duration>0?(r=Math.max(r,e.currentTime/e.duration*100),(e.ended||e.currentTime>=e.duration-.1)&&(r=100)):r+=.3}if(r>=100){d||(d=!0,w());const y=window.hero3DReady||!1;v++,y||v>120?r=100:(r=99.9,s&&(s.innerText="● PREPARING..."))}i&&(i.innerText=Math.floor(r)),a&&(a.style.width=`${r}%`),f&&(f.style.left=`${r}%`),(r<100||!d)&&requestAnimationFrame(m)}};setTimeout(m,400),setTimeout(()=>{r<10&&(console.warn("Loader safety bypass triggered: Video may have failed to load."),r=100,d||(d=!0,w()))},5e3);function w(){c&&(c.style.opacity="0",c.style.transform="translateY(10px)"),l&&(l.style.opacity="0"),p&&(p.style.opacity="0"),e.style.transform="translate(-50%, -50%) scale(10)",e.style.filter="blur(15px) brightness(1.8)",setTimeout(()=>{o&&o(),n.style.transition="opacity 1s ease-out",n.style.opacity="0",setTimeout(()=>{n.remove()},1e3)},1500)}}const O="modulepreload",M=function(o){return"/Stone-Oven/"+o},b={},h=function(e,n,t){let i=Promise.resolve();if(n&&n.length>0){let p=function(s){return Promise.all(s.map(u=>Promise.resolve(u).then(r=>({status:"fulfilled",value:r}),r=>({status:"rejected",reason:r}))))};var f=p;document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),l=c?.nonce||c?.getAttribute("nonce");i=p(n.map(s=>{if(s=M(s),s in b)return;b[s]=!0;const u=s.endsWith(".css"),r=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${r}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":O,u||(d.as="script"),d.crossOrigin="",d.href=s,l&&d.setAttribute("nonce",l),document.head.appendChild(d),u)return new Promise((v,m)=>{d.addEventListener("load",v),d.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${s}`)))})}))}function a(c){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=c,window.dispatchEvent(l),!l.defaultPrevented)throw c}return i.then(c=>{for(const l of c||[])l.status==="rejected"&&a(l.reason);return e().catch(a)})};function E(){const o={threshold:.1},e=new IntersectionObserver(t=>{t.forEach(i=>{i.isIntersecting&&i.target.classList.add("active")})},o);document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function A(){const o=()=>{const e=window.location.hash.slice(1)||"/",n=document.getElementById("app"),t=document.querySelector(".navbar");document.body.style.overflow="",document.documentElement.style.overflow="",t&&t.classList.remove("nav-hidden"),window.scrollTo(0,0),e==="/"?g("home"):e==="/locations"?g("locations"):e==="/menu"?g("menu"):e==="/gallery"?g("gallery"):e==="/about"?g("about"):n.innerHTML="<h1>404 - Page Not Found</h1>"};window.addEventListener("hashchange",o),o()}async function g(o,e){const n=document.getElementById("app");try{let t;o==="home"?(t=await h(()=>import("./Home-BjCeuIbF.js"),__vite__mapDeps([0,1,2])),n.innerHTML=t.renderHome()):o==="locations"?(t=await h(()=>import("./Locations-D_JNJKCB.js"),__vite__mapDeps([3,1,2,4])),n.innerHTML=t.renderLocations()):o==="menu"?(t=await h(()=>import("./Menu-D5rifyPA.js"),__vite__mapDeps([5,1,2])),n.innerHTML=t.renderMenu()):o==="gallery"?(t=await h(()=>import("./Gallery-BVDfHCOO.js"),[]),n.innerHTML=t.renderGallery()):o==="about"&&(t=await h(()=>import("./About-Cg_txZNk.js"),__vite__mapDeps([6,1,4])),n.innerHTML=t.renderAbout()),t&&t.init&&t.init(),t&&t.initGallery&&t.initGallery(),E()}catch(t){console.error("Failed to load page:",t),n.innerHTML="<h1>Error loading page</h1>"}}function S(){const o=document.getElementById("navbar");o.innerHTML=`
        <nav class="navbar">
