...
export function renderAbout() {
    ...
    const contactCards = outlets.map((outlet, i) => `
        <div class="contact-card reveal" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 16px; padding: 2.5rem; transition: transform 0.4s ease, border-color 0.4s ease; cursor: default; position: relative; overflow: hidden;">
            <div style="position: absolute; top: -20px; right: -20px; font-size: 8rem; color: rgba(255, 255, 255, 0.02); font-family: 'Playfair Display', serif; z-index: 0; pointer-events: none;">0${i + 1}</div>
            <div style="position: relative; z-index: 1;">
                <h3 style="font-family: 'Playfair Display', serif; font-size: 1.8rem; color: #fff; margin-top: 0; margin-bottom: 1rem;">${outlet.name.split(' ').pop()}</h3>
                <p style="color: rgba(255,255,255,0.6); font-size: 0.95rem; line-height: 1.6; margin-bottom: 2rem; min-height: 3em;">${outlet.address}</p>
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <a href="tel:${outlet.phone.replace(/\s+/g, '')}" class="call-btn" style="display: inline-flex; align-items: center; justify-content: center; gap: 10px; background: #ff3c00; color: #fff; text-decoration: none; padding: 1rem; border-radius: 8px; font-weight: 600; transition: all 0.3s ease; margin-top: 0.5rem;">
        ...
        <div class="about-page" style="position: relative; overflow: hidden; background: #0c0b0a; color: #fff;">
            ...
            <div class="container" style="position: relative; z-index: 1; padding-top: 160px; padding-bottom: 100px; max-width: 1200px; margin: 0 auto; padding-left: 5%; padding-right: 5%;">
                ...
                <div class="reveal" style="margin-top: 12rem; text-align: center; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 6rem;">
                    <img src="${baseUrl}logo.png" alt="Stone Oven" style="height: 60px; opacity: 0.3; filter: grayscale(1); margin-bottom: 2rem;">
...
export function init() {
    initHeatFlow('about-heat-canvas');
}
